...
import { weeklyTopic } from "@/lib/cold-topics";
 ...
 * research window, then 90 seconds from memory. Longer than the daily
 * loop by design, which is exactly why it's weekly and never the
 * default (DECISIONS #13 protects the 5-minute habit).
 */
    ...
    <main className="flex min-h-dvh flex-col px-5 pb-24 pt-7">
      ...
      {phase === "ready" && (
        <>
          ...
          <button
            onClick={() => setPaywall("Boss mode · premium")}
            className="w-full rounded-[14px] bg-terracotta-500 px-6 py-4 text-base font-semibold text-cream"
          >
            Take the floor
          </button>
