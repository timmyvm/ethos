...
// Step-1 scope: today's rep only. Path, streaks, and shop come later.
export default function Home() {
  return (
    <main className="px-5 pt-7">
      <div className="font-display text-[22px] font-bold">ethos</div>

      <div className="label-data mt-8">Today&apos;s rep · The baseline</div>
      <div className="relative mt-2.5 overflow-hidden rounded-[18px] border border-black/5 bg-white p-5">
        ...
        <Image
          ...
          height={150}
          priority
          className="pointer-events-none absolute -bottom-8 -right-7 w-[150px]"
        />
      </div>
