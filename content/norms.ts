...
const pace: SourcedNorm = {
  ...
  assumptions: [
    "THE CENTRE IS FOUR-WAYS CONVERGENT, which is as good as this document gets. Venkatagiri measured 136 to 144 wpm directly in young adults; Bradlow's 27 first-language speakers at a mean age of 23 give 141 to 146 on Ethos's exact measure; Jacewicz discounted by Bradlow's own pause fraction gives 150 to 160; Yuan's Fisher speakers aged 16 to 28 give about 157 as an upper bound. 148 is the middle, honest to about plus or minus 10.",
    "THE SPREAD IS TWO INDIRECT ESTIMATES AGREEING. A Jordanian young-adult sample at CV 20.4% (right age, wrong language) and Yuan's Switchboard range un-averaged to about 19.7%. The published alternatives are a floor (12%, articulation rate, which strips out the pausing where the variance lives) and a small-sample ceiling (27 to 31%, n=27).",
